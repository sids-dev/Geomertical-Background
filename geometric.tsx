    ...
    <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-[#030303]">
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            <Image src="/white-bird.png" alt="White Bird" width={60} height={60} className="mb-4" />
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/[0.03] border border-white/[0.08]">
              <Image src="/sids-logo.svg" alt="SIDS UI" width={20} height={20} />
          ...
          <motion.div custom={2} variants={fadeUpVariants} initial="hidden" animate="visible">
            <p className="text-base sm:text-lg md:text-xl text-white/40 mb-8 leading-relaxed font-light tracking-wide max-w-xl mx-auto px-4">
              Unleashing innovative solutions through cutting-edge design and transformative technology.
            </p>
          </motion.div>
        </div>
      </div>
